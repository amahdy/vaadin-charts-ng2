System.register(['angular2/core', './population-list/population_list.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, population_list_component_1;
    var PopulationApp;
    return {
        setters:[
            function (core_1_1) {
            ...
            PopulationApp = (function () {
                ...
                PopulationApp = __decorate([
                    core_1.Component({
                        ...
                        directives: [population_list_component_1.PopulationList]
                    }), 
